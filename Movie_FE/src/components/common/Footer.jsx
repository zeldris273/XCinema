      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            MovieApp is a platform to discover, rate, and follow your favorite movies and TV shows. Join our community to share your thoughts!            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/movies" className="hover:text-yellow-400 transition-colors duration-300">
                  Movies
                </Link>
              </li>
              <li>
                <Link to="/tv" className="hover:text-yellow-400 transition-colors duration-300">
                  TV Shows
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-neutral-600 mt-8 pt-6 text-center">
          <p className="text-sm">
            &copy; {new Date().getFullYear()} MovieApp. All rights reserved. Created by <span className="text-yellow-400">Nvh</span>.
          </p>
        </div>
      </div>
    </footer>
