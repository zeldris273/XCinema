...
namespace backend.Migrations
{
    ...
    [Migration("20251206090002_AddCommentIdToLikes")]
    partial class AddCommentIdToLikes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Movie_BE.Models.Genre", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Movie_BE.Models.MovieGenre", b =>
                {
                    b.Property<int>("MovieId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Movie_BE.Models.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Movie_BE.Models.TvSeriesGenre", b =>
                {
                    b.Property<int>("TvSeriesId")
                        .HasColumnType("integer");
                    ...
                    b.HasKey("TvSeriesId", "GenreId");

                    b.HasIndex("GenreId");

                    b.HasIndex("GenreId1");

                    b.ToTable("TvSeriesGenres");
                });
            ...
            modelBuilder.Entity("backend.Models.Movie", b =>
                {
                    ...
                    b.Property<NpgsqlTsVector>("SearchVector")
                        ...
                        .HasAnnotation("Npgsql:TsVectorProperties", new[] { "Title", "Overview" });
            ...
            modelBuilder.Entity("Movie_BE.Models.MovieGenre", b =>
                {
                    b.HasOne("Movie_BE.Models.Genre", "Genre")
                        .WithMany()
                        .HasForeignKey("GenreId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Movie_BE.Models.Genre", null)
            ...
            modelBuilder.Entity("Movie_BE.Models.Notification", b =>
                {
                    ...
                    b.HasOne("backend.Models.CustomUser", "RepliedByUser")
                        .WithMany()
